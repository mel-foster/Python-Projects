...
ec2_count =int(input("Enter the number of AWS EC2 Instances Needed. *Note: You will be prompted to complete requested information to generate name for total request(s).")) #Enter the number of EC2 Instances and the counter will be triggered through each interaction.
...
while count != ec2_count:
    ...
    if ec2_name in depts:
        ...
        ec2_name =str(input("\nPlease, Try Again. Select from one of the following departments: Accounting, FinOps, or Marketing\n"))
